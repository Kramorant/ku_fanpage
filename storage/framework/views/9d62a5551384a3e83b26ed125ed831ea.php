...
<?php $__currentLoopData = $kaiju->attacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="attackModal<?php echo e($attack->id); ?>" tabindex="-1"
     aria-labelledby="attackModalLabel<?php echo e($attack->id); ?>" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background:#2a2a2a; border:1px solid #3a3a3a; color:#e0e0e0">
            <div class="modal-header" style="border-bottom:1px solid #3a3a3a">
                <h5 class="modal-title fw-bold" id="attackModalLabel<?php echo e($attack->id); ?>"
                    style="color:var(--ku-accent)">
                    <?php echo e($attack->name); ?>
            ...
            <div class="d-flex gap-4">
                <div>
                    ...
                    <div class="fw-bold" style="color:var(--ku-text); font-size:1.1rem">
                        <?php echo e(number_format($baseStat->health_min, 0)); ?>
                ...
                <div>
                    ...
                    <div class="fw-bold" style="color:var(--ku-accent); font-size:1.1rem">
                        <?php echo e(number_format($baseStat->health_max, 0)); ?>
        ...
        <div class="col-md-6 p-3">
            ...
            <div class="d-flex gap-4">
                <div>
                    <div class="text-secondary" style="font-size:.7rem">Min</div>
                    <div class="fw-bold" style="color:var(--ku-text); font-size:1.1rem">
                        <?php echo e(number_format($baseStat->regen_min, 2)); ?>%
                    </div>
                </div>
                <div>
                    <div class="text-secondary" style="font-size:.7rem">Max</div>
                    <div class="fw-bold" style="color:var(--ku-accent); font-size:1.1rem">
                        <?php echo e(number_format($baseStat->regen_max, 2)); ?>%
                    </div>
                </div>
            </div>
            <?php else: ?>
        ...
        <div class="d-flex flex-column gap-2">
            ...
            <div class="d-flex justify-content-between align-items-center px-3 py-2 rounded-2"
                ...
                <span class="text-secondary">
                    <i class="bi <?php echo e($sp['icon']); ?> me-2"></i><?php echo e($sp['label']); ?>

                </span>
                <span class="fw-bold" style="color:var(--ku-text)">
                    <span style="color:var(--ku-text)"><?php echo e(number_format($sp['min'], 2)); ?></span>
                    <span class="text-secondary mx-1">–</span>
                    <span style="color:var(--ku-accent)"><?php echo e(number_format($sp['max'], 2)); ?></span>
                    <small class="text-secondary fw-normal ms-1">u/s</small>
                </span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($speedRow->flying_min !== null): ?>
            <div class="d-flex justify-content-between align-items-center px-3 py-2 rounded-2"
                 style="background:#252525">
                <span class="text-secondary">
                ...
                <span class="fw-bold" style="color:var(--ku-text)">
                    <span style="color:var(--ku-text)"><?php echo e(number_format($speedRow->flying_min, 2)); ?></span>
                    <span class="text-secondary mx-1">–</span>
                    <span style="color:var(--ku-accent)"><?php echo e(number_format($speedRow->flying_max, 2)); ?></span>
                    <small class="text-secondary fw-normal ms-1">u/s</small>
                </span>
            </div>
            <?php endif; ?>
        ...
        <?php else: ?>
            <div class="d-flex flex-column gap-2">
                ...
                <button
                    ...
                    data-bs-target="#attackModal<?php echo e($attack->id); ?>"
                >
                    <span style="color:var(--ku-text); font-weight:600"><?php echo e($attack->name); ?></span>
                    <span class="badge ms-2" style="background:var(--ku-accent); color:#111">
                        <?php echo e(number_format($attack->damage_min, 0)); ?> – <?php echo e(number_format($attack->damage_max, 0)); ?>
...
<?php /**PATH C:\xampp\htdocs\ku_fanpage\resources\views/components/kaiju-stats.blade.php ENDPATH**/ ?>