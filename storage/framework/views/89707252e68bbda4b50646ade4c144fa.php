...
<?php $__env->startSection('title', 'Edit ' . $kaiju->name); ?>
...
<div class="container" style="max-width:900px">
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <h1 class="fw-bold mb-0" style="color:var(--ku-accent)">Edit: <?php echo e($kaiju->name); ?></h1>
    </div>

    <form method="POST" action="<?php echo e(route('admin.kaijus.update', $kaiju)); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('name', $kaiju->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('slug', $kaiju->slug)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" rows="4" class="form-control"><?php echo e(old('description', $kaiju->description)); ?></textarea>
                </div>
                <div class="col-md-6">
                    ...
                    <?php if($kaiju->image): ?>
                    <div class="mt-2">
                        <img src="<?php echo e(Storage::url($kaiju->image)); ?>" height="60"
        ...
        <div class="card-ku p-4 rounded-3 mb-4" id="attacksSection">
            ...
            <p id="noAttacksMsg" class="text-secondary fst-italic mb-0"
               style="<?php echo e($kaiju->attacks->isNotEmpty() ? 'display:none' : ''); ?>">
                No attacks yet. Click "Add Attack" to add one.
            </p>
        </div>

        
        <?php $speedRow = $kaiju->speeds->first(); ?>
        <div class="card-ku p-4 rounded-3 mb-4">
            <h5 class="fw-bold mb-3" style="color:var(--ku-accent)">
            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="speed[<?php echo e($sp['key']); ?>_min]"
                           class="form-control"
                           value="<?php echo e(old("speed.{$sp['key']}_min", $speedRow?->{$sp['key'].'_min'} ?? 0)); ?>"
                           placeholder="0.00">
                </div>
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="speed[<?php echo e($sp['key']); ?>_max]"
                           class="form-control"
                           value="<?php echo e(old("speed.{$sp['key']}_max", $speedRow?->{$sp['key'].'_max'} ?? 0)); ?>"
                           placeholder="0.00">
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <div class="row g-2 mb-2">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="speed[flying_min]"
                           class="form-control"
                           value="<?php echo e(old('speed.flying_min', $speedRow?->flying_min)); ?>"
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="speed[flying_max]"
                           class="form-control"
                           value="<?php echo e(old('speed.flying_max', $speedRow?->flying_max)); ?>"
                           placeholder="Leave blank if can't fly">
                </div>
            </div>
        </div>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('admin.kaijus.index')); ?>" class="btn btn-outline-secondary">Cancel</a>
        </div>
    </form>
</div>
...
<script>
    let attackIndex = <?php echo e($kaiju->attacks->count()); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ku_fanpage\resources\views/admin/kaiju/edit.blade.php ENDPATH**/ ?>