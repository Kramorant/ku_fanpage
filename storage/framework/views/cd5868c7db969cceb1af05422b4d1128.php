...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Kaiju Universe Fan Wiki'); ?></title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('wiki.*') ? 'active' : ''); ?>"
                       href="<?php echo e(route('wiki.index')); ?>">Wiki</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav ms-auto align-items-center gap-2">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn-ku-admin">
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item">
                        <a class="btn btn-ku btn-sm" href="<?php echo e(route('register')); ?>">Register</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
...
<footer class="py-4 mt-5 text-center">
    <div class="container">
        ...
        <small class="text-secondary">&copy; <?php echo e(date('Y')); ?> KU Fan Wiki</small>
    </div>
</footer>
...
<?php /**PATH C:\xampp\htdocs\ku_fanpage\resources\views/layouts/app.blade.php ENDPATH**/ ?>