...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="text-center text-secondary mt-3 mb-0">
                    ...
                    <a href="<?php echo e(route('login')); ?>" style="color:var(--ku-accent)">Login here</a>
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ku_fanpage\resources\views/auth/register.blade.php ENDPATH**/ ?>